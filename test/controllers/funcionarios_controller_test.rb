...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { matricula: @funcionario.matricula, pessoa_id: @funcionario.pessoa_id } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { matricula: @funcionario.matricula, pessoa_id: @funcionario.pessoa_id } }
